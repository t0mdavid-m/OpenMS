...
// --------------------------------------------------------------------------
#ifndef OPENMS_CHEMISTRY_FLASHIDAPROFORMA_H
#define OPENMS_CHEMISTRY_FLASHIDAPROFORMA_H
...
namespace OpenMS
{
    ...
    class OPENMS_DLLAPI FlashIdaProForma
    {
    public:
        // Constructor
        explicit FlashIdaProForma(const AASequence& seq);
...
#endif // OPENMS_CHEMISTRY_FLASHIDAPROFORMA_H
